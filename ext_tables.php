...
(static function () {
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_openinghours_domain_model_override', 'EXT:openinghours/Resources/Private/Language/locallang_csh_tx_openinghours_domain_model_override.xlf');
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_openinghours_domain_model_override');
})();
