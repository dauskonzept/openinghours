How to contribute
=================
Hey, great you want to contribute to ``openinghours``.

Submitting feedback
===================
Please report feedback, bugs and feature requests on [GitHub](https://github.com/dauskonzept/openinghours/issues)
Note, that the GitHub issue tracker is not a support forum.

I'm always willing to help user of ``openinghours`` with potential problems, but please understand, that I will
...
=======================
Not every feature is relevant for the bulk of ``openinghours`` users, so please discuss new features in the
issue tracker on [GitHub](https://github.com/dauskonzept/openinghours/issues) before starting to code.

Submitting changes
==================
* Create a fork of the ``openinghours``  repository on GitHub
...
Coding Standards
================
The ``openinghours`` codebase follows [PSR-1](https://www.php-fig.org/psr/psr-1/),
[PSR-2](https://www.php-fig.org/psr/psr-2/) and [PSR-12](https://www.php-fig.org/psr/psr-12/) standards for code formatting.

Testing
=======
A wide range of the codebase of ``openinghours`` is covered by unit- and functional tests. If you submit a pull
